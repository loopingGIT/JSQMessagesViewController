 ...
 */
- (void)collectionView:(JSQMessagesCollectionView *)collectionView didTapMessageBubbleAtIndexPath:(NSIndexPath *)indexPath withGesture:(UIGestureRecognizer *)gesture;
- (void)collectionView:(JSQMessagesCollectionView *)collectionView didDoubleTapMessageBubbleAtIndexPath:(NSIndexPath *)indexPath withGesture:(UIGestureRecognizer *)gesture;
